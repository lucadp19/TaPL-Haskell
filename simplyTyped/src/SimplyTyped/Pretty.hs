...
{- |
The "SimplyTyped.Pretty" module contains some helper functions for pretty-printing
terms and REPL results.
-}

module SimplyTyped.Pretty 
...
{- |
'prettyTerm' is used to prettyfy terms: it takes a 'SimplyTyped.Syntax.Term' 
and returns a prettyfied version contained in a @'MonadReader' env@ monad.

The canonical choice for the monad is @'SimplyTyped.Monad.Eval'@.
-}
