...
{- |
The "SimplyTyped.Check" module implements the main typechecking function ('typeof')
plus some other auxiliary functions for types and type errors.
-}

module SimplyTyped.Check 
    ( -- * Typechecker
      typeof
    , ( <?> )
      -- * Type Errors
...
The usual choice for the monad is @'Control.Monad.Except.ExceptT' 'TypeErr' 'SimplyTyped.Eval'@.
-}
...
@'Control.Monad.Except.ExceptT' 'TypeErr' 'SimplyTyped.Eval'@ monad: 
